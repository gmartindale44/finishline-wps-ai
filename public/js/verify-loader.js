;(function () {
  ...
  try {
    console.info("%c FinishLine Verify Loader — modal r22 ", "background:#6b46c1;color:#fff;padding:2px 6px;border-radius:4px");
  } catch {}
  ...
  const run = async () => {
    ...
    try { await inject("/js/verify-modal.js?v=v2025-11-10-22"); } catch {}
