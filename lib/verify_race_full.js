...
function parseHRNRaceOutcome($, ctx = {}) {
  ...
  for (const h of horses) {
    ...
    // SHOW: row with S only (no Win/Place)
  ...
  // Final fallback: if we STILL don't have 3 unique horses but have at least one,
  // keep whatever we found; it's better than nothing.
  return {
    win: winHorse,
    place: placeHorse,
    show: showHorse,
